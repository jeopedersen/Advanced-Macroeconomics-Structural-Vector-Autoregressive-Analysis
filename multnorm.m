...
%}
  ...
  tableforlatex = table(({'joint test statistic:' ; 'p-value' ; 'degrees of freedom' ; 'Skewness only' ; 'p-value' ; 'kurtosis only'; 'p-value'}),norm(:,1),norm(:,2),'VariableNames',{'Test' 'Doornik_Hansen' 'Lutkepohl'});
  table2latex(tableforlatex,'mNorm.tex')
end
